...
BOOL CTwain::InitTwain(HWND hWnd)
{
	...
	m_hMessageWnd = hWnd;
	StringCchCopy(libName,512,"TWAIN_32.DLL");
...
void CTwain::GetIdentity()
{
	...
	//m_AppId.Version.Info = "1.0.2.0";
	m_AppId.ProtocolMajor = TWON_PROTOCOLMAJOR;
	m_AppId.ProtocolMinor = TWON_PROTOCOLMINOR;
	m_AppId.SupportedGroups = DG_IMAGE | DG_CONTROL;
	//m_AppId.Manufacturer = "MICSS";
	//m_AppId.ProductFamily = "Picture viewer";
	//m_AppId.ProductName = "Regards";
...
TW_PENDINGXFERS twPend;
	...
	{
		SendMessage(m_hMessageWnd,WM_COMMAND,MAKEWPARAM(TWCPP_ENDTRANSFER,0),0);
...
BOOL CTwain::GetImage(TW_IMAGEINFO& info)
{
	...
	case TWRC_XFERDONE:
			{
				CopyImage(m_hMessageWnd,hBitmap,info);
			}
			break;
	case TWRC_CANCEL:
			break;
