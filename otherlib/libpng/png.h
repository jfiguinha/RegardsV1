...
extern PNG_EXPORT(int,png_read_info) PNGARG((png_structp png_ptr,
   png_infop info_ptr));
...
/* read a row of data. */
extern PNG_EXPORT(int,png_read_row) PNGARG((png_structp png_ptr,
   png_bytep row,
   png_bytep display_row));

/* read the whole image into memory at once. */
extern PNG_EXPORT(int,png_read_image) PNGARG((png_structp png_ptr,
   png_bytepp image));
