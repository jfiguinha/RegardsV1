...
CSqlExecuteRequest::CSqlExecuteRequest(const string & databaseName)
{
...
bool CSqlExecuteRequest::ExecuteInsertBlobData(const string &requestSQL, const int &numCol, const void * zBlob, const int &nBlob)
{
...
//-------------------------------------------------------------------------------------------------
int CSqlExecuteRequest::ExecuteRequestWithNoResult(const string &requestSQL)
{
  //  string query;
...
int64_t CSqlExecuteRequest::GetLastId()
{
	...
	else
	{
		...
		{
            //string database_error = "DatabaseCorrupt";
			MessageBox(NULL,"DatabaseCorrupt","Error", MB_ICONERROR);
			exit(1);
		}
...
int CSqlExecuteRequest::ExecuteRequest(const string &requestSQL)
{
	int nbResult = 0;			// Error code reporting
