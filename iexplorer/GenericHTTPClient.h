...
public:					
	...
	// HTTP Method handler 
	BOOL Request(LPCTSTR szURL, int iUrlSize, int nMethod = GenericHTTPClient::RequestGetMethod, LPCTSTR szAgent = __DEFAULT_AGENT_NAME);
	...
	VOID ParseURL(LPCTSTR szURL, int iUrlSize, LPTSTR szProtocol, int iProtocolSize, LPTSTR szAddress, int iAddressSize, DWORD &dwPort, LPTSTR szURI, int iURISize);
