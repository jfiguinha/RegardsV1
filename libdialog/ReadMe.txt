========================================================================
    BIBLIOTHÈQUE STATIQUE : vue d'ensemble du projet libdialog
========================================================================

AppWizard a créé ce projet de bibliothèque libdialog pour vous. 
Ce fichier contient un résumé du contenu de chacun des fichiers qui
constituent votre application libdialog.
...
StdAfx.h, StdAfx.cpp
    ...
    nommé libdialog.pch et un fichier de type précompilé nommé StdAfx.obj.
