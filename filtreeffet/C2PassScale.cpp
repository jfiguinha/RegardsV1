...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
COLORREF * C2PassScale::AllocAndScale(COLORREF *pOrigImage, UINT uOrigWidth, UINT uOrigHeight, UINT uNewWidth, UINT uNewHeight)
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
COLORREF * C2PassScale::Scale(COLORREF *pOrigImage, UINT uOrigWidth, UINT uOrigHeight, COLORREF *pDstImage, UINT uNewWidth, UINT uNewHeight)
{
    // Scale source image horizontally into temporary image
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
C2PassScale::LineContribType * C2PassScale::AllocContributions (UINT uLineLength, UINT uWindowSize)
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
C2PassScale::LineContribType * C2PassScale::CalcContributions(UINT uLineSize, UINT uSrcSize, double  dScale)
{
    double dWidth;
    double dFScale = 1.0;
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
void C2PassScale::ScaleRow(COLORREF *pSrc, UINT uSrcWidth,COLORREF *pRes, UINT uResWidth,UINT uRow, LineContribType *Contrib)
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
void C2PassScale::HorizScale(COLORREF *pSrc, UINT uSrcWidth,UINT uSrcHeight,COLORREF *pDst,UINT uResWidth,UINT uResHeight)
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
void C2PassScale::ScaleCol(COLORREF *pSrc, UINT uSrcWidth,COLORREF *pRes, UINT uResWidth,UINT uResHeight,UINT uCol, LineContribType *Contrib)
{
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////
void C2PassScale::VertScale(COLORREF *pSrc, UINT uSrcWidth, UINT uSrcHeight, COLORREF *pDst, UINT uResWidth, UINT uResHeight)
{
