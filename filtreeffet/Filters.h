...
class CBoxFilter : public CFast2PassScale
{
public:

    CBoxFilter (double dWidth = double(0.5)) : CFast2PassScale(dWidth) {}
    virtual ~CBoxFilter() {}
...
class CBilinearFilter : public CFast2PassScale
{
public:

    CBilinearFilter (double dWidth = double(1.0)) : CFast2PassScale(dWidth) {}
...
class CGaussianFilter : public CFast2PassScale
{
public:

    CGaussianFilter (double dWidth = double(1.25)) : CFast2PassScale(dWidth) {}
...
class CHammingFilter : public CFast2PassScale
{
public:

    CHammingFilter (double dWidth = double(1.0)) : CFast2PassScale(dWidth) {}
...
class CCubicFilter : public CFast2PassScale
{
public:

    CCubicFilter (double dWidth = double(2.0)) : CFast2PassScale(dWidth) {}
...
class CBlackmanFilter : public CFast2PassScale
{
public:

    CBlackmanFilter (double dWidth = double(1.0)) : CFast2PassScale(dWidth) {}
...
class CQuadraticFilter : public CFast2PassScale
{
public:

    CQuadraticFilter (double dWidth = double(1.5)) : CFast2PassScale(dWidth) {}
...
class CMitchellFilter : public CFast2PassScale
{
public:

    CMitchellFilter (double dWidth = double(2.0)) : CFast2PassScale(dWidth) {}
...
class CTriangleFilter : public CFast2PassScale
{
public:

    CTriangleFilter (double dWidth = double(1.0)) : CFast2PassScale(dWidth) {}
...
class CSincFilter : public CFast2PassScale
{
public:

    CSincFilter (double dWidth = double(1.5)) : CFast2PassScale(dWidth) {}
    virtual ~CSincFilter() {}
...
class CBesselFilter : public CFast2PassScale
{
public:

    CBesselFilter (double dWidth = double(1.5)) : CFast2PassScale(dWidth) {}
...
class CBlackmanBesselFilter : public CFast2PassScale
{
public:

    CBlackmanBesselFilter (double dWidth = double(3.2383)) : CFast2PassScale(dWidth) {}
...
class CLanczosFilter : public CFast2PassScale
{
public:

    CLanczosFilter (double dWidth = double(3.0)) : CFast2PassScale(dWidth) {}
...
class CBlackmanSincFilter : public CFast2PassScale
{
public:

    CBlackmanSincFilter (double dWidth = double(4.0)) : CFast2PassScale(dWidth) {}
...
class CCatromFilter : public CFast2PassScale
{
public:

    CCatromFilter (double dWidth = double(2.0)) : CFast2PassScale(dWidth) {}
...
class CHanningFilter : public CFast2PassScale
{
public:

    CHanningFilter (double dWidth = double(1.0)) : CFast2PassScale(dWidth) {}
...
class CHermiteFilter : public CFast2PassScale
{
public:

    CHermiteFilter (double dWidth = double(1.5)) : CFast2PassScale(dWidth) {}
